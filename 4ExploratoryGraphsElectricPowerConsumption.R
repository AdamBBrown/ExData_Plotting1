...
par(mfrow = c(2,2), mar = c(4, 4, 2, 1), oma = c(0, 0, 0, 0)) #bottom, left, top, right
#1
with(electricPowerConsumptionSubset, plot(datetime, Global_active_power, type="l", xlab = "", ylab = "Global Active Power", cex.axis = 0.7, cex.lab = 0.7))
#2
with(electricPowerConsumptionSubset, plot(datetime, Voltage, type="l", cex.axis = 0.7, cex.lab = 0.7))
#3
with(electricPowerConsumptionSubset, plot(datetime, Sub_metering_1, type="n", xlab = "", ylab = "Energy sub metering", cex.axis = 0.7, cex.lab = 0.7))
...
legend("topright", lty = c(1,1), bty = "n", cex=0.6, col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
#4
with(electricPowerConsumptionSubset, plot(datetime, Global_reactive_power, type="l", cex.axis = 0.7, cex.lab = 0.7))
...
dev.copy(png, file = "./figure/4ExploratoryGraphsElectricPowerConsumption.png")

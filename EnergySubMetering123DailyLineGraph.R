...
with(electricPowerConsumptionSubset, plot(datetime, Sub_metering_1, type="n", xlab = "", ylab = "Energy sub metering", cex.lab = 0.6, cex.axis = 0.7))
...
legend("topright", lty = c(1,1), cex = 0.5, col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
...
dev.copy(png, file = "./figure/EnergySubMetering123DailyLineGraph.png")

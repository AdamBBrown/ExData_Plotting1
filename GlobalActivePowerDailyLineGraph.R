...
#draw a line chart showing the daily global active power usage for 2/1/2007 and 2/2/2007
with(electricPowerConsumptionSubset, plot(datetime, Global_active_power, type="l", xlab = "", ylab = "Global Active Power (kilowatts)", cex.lab = 0.7, cex.axis = 0.7))
...
dev.copy(png, file = "./figure/GlobalActivePowerDailyLineGraph.png")
